...
class CLG
{
  public:
   CLG();
   CLG(short, short);
   CLG( unsigned long, std::vector<short>, std::vector<bool>, short, short );
   CLG( unsigned long, std::vector<double>, std::vector<bool>, short, short );
   ~CLG();
   void SetModel(short, short, double);
   void SetResponse( unsigned long, std::vector<short>, std::vector<bool> );
   void SetResponse( unsigned long, std::vector<double>, std::vector<bool> );
   unsigned short Maximize( double&, double*, short*, double*,
  ...
  void SetPriorParams( std::vector<double>, std::vector<double> );
...
private:
  double getXij( const short*, const std::vector< std::vector<double> >&,
		 const std::vector< std::vector<double> >&, const std::vector<short>&,
		 const std::vector<bool>&, long, long );
  ...
  void getEta( double, const double*, const short*, const double*,
	       const std::vector<short>&, const std::vector<bool>&, unsigned long,
	       const std::vector<std::vector<double> >&,
	       const std::vector<std::vector<double> >&,
...
//   std::vector< double > X_work;
  ...
  std::vector<double> DerivativeAtOrigin;
  std::vector<double> DDerivativeAtOrigin;
